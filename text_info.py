...
class TextInfo:
    ...
    help: ClassVar[str] = (
        ...
        "    forecast_list 或 fcls --------- 列出指定年份区间的假期情况。\n"
        "    forecast_nearly 或 fcnearly --- 预测距今最近的假期\n"
        "    quit 或 exit ------------------ 退出程序。\n"
        "\n"
        "参数 (argument)：\n"
    ...
    international_labours_day_note: ClassVar[str] = """NOTE: 五一的放假方式经历过三次修改。
      最早，五一放假7天；然后，五一放假3天；接着，五一放假5天，调休2天；时至今日，五一放假5天，调休1天。
      在本程序中，统一以放假五天，调休一天为准。
      因此，在预测以前的五一假期时，本程序给出的结果并不准确。
      并且，由于在本项目制作五一部分时是第一个放假5天，调休1天的五一假期，没有过往的历史可以参考，
      在预测未来的春节假期时，也不一定准确。\n"""

    spring_festival_note: ClassVar[str] = """NOTE: 春节的放假方式经历过三次修改。
      最早，除夕不放假，且假期共7天；然后，除夕放假，且假期共7天；接着，除夕不放假，但放假8天；时至今日，除夕放假，且放假8天。
      在本程序中，统一以除夕放假，且放假8天为准。
      因此，在预测以前的春节假期时，本程序给出的结果并不准确。
      并且，由于在本项目制作春节部分时是第一个除夕放假，连放8天的春节，没有过往的历史可以参考，
      在预测未来的春节假期时，也不一定准确。"""
